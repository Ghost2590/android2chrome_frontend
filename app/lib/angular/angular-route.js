...
function $RouteProvider(){
  ...
  this.$get = ['$rootScope', '$location', '$routeParams', '$q', '$injector', '$http', '$templateCache', '$sce',
     ...
     *
     * @description
     * `$route` is used for deep-linking URLs to controllers and views (HTML modules).
 ...
 * <pre>
 *  // Given:
 *  // URL: http://server.com/options.html#/Chapter/1/Section/2?search=moby
 ...
 * including the rendered template of the current route into the main layout (`options.html`) file.
