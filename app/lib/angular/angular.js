 ...
 * that the URLs used for sourcing Angular templates are safe.  Refer {@link * ng.$sceDelegateProvider#resourceUrlWhitelist $sceDelegateProvider.resourceUrlWhitelist}
 * and * {@link ng.$sceDelegateProvider#resourceUrlBlacklist $sceDelegateProvider.resourceUrlBlacklist}
 *
...
function $SceDelegateProvider() {
  ...
  this.$get = ['$log', '$document', '$injector', '$$urlUtils', function(
     ...
     * {@link     * ng.$sceDelegate#trustAs `$sceDelegate.trustAs`}, returns it as-is.
     *
 ...
 * {@link ng.$sce#trustAsResourceUrl wrap them} as trusted values. Refer to Angular's
